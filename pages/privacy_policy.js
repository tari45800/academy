  ...
  return (
    <PageLayout>
      ...
      <div>
        ...
        <h3>제1조(목적)</h3>
        <p>
          주식회사 투에스에듀(이하 &#x27;회사&#x27;라고 함)는 회사가 제공하고자 하는 서비스(이하 &#x27;회사
          서비스&#x27;)를 이 용하는 개인(이하 &#x27;이용자&#x27; 또는 &#x27;개인)의 정보(이하 &#x27;개인정보&#x27;)를
          보호하기 위해, 개인정보보호법, 정 보통신망 이용촉진 및 정보보호 등에 관한 법률(이하 &#x27;정보통신망법&#x27;)
          등 관련 법령을 준수하고, 서비스 이용자의 개인정보 보호 관련한 고층을 신속하고 원활하게 처리할 수 있도록 하기
          위하여 다음과 같이 개인정보처리방침(이하 &#x27;본 방침&#x27;)을 수립합니다.
        </p>
        <br />
        <h3>제2조(개인정보 처리의 원칙)</h3>
        <p>
          개인정보 관련 법령 및본 방침에 따라 회사는 이용자의 개인정보를 수집할 수 있으며 수집된 개인정보 는 개인의
          동의가 있는 경우에 한해 제3자에게 제공될 수 있습니다. <br /> 단, 법령의 규정 등에 의해 적법하 게 강제되는 경우
        ...
        <ol type="1" start="2">
          <li>
            회사는 제1항에 따라 본 방침을 공개하는 경우 글자 크기, 색상 등을 활용하여 이용자가 본 방침을 쉽게 확 인할 수
            있도록 합니다.
          </li>
        </ol>
        <br />
        ...
        <ol type="1" start="1">
          <li>
            본 방침은 개인정보 관련 법령, 지침, 고시 또는 정부나 회사 서비스의 정책이나 내용의 변경에 따라 개정 될 수
            있습니다.
            <br />
          </li>
        </ol>
        <ol type="1" start="2">
          <li>
            ...
            <br />
            <p>나. 서면 모사선송 전자우편 또는 이와 비슷한 방법으로 이용자에게 공지하는 방법</p>
          </li>
        </ol>
        <ol type="1" start="3">
          <li>
        ...
        <ol type="1" start="1">
          <li>필수 수집 정보: 이메일 주소, 비밀번호, 이름, 생년월일 및 휴대폰 번호</li>
        </ol>
        <br />
        <h3>제6조(본인 인증을 위한 정보)</h3>
        <p>회사는 이용자의 본인인증을 위하여 다음과 같은 정보를 수집합니다.</p>
        <ol type="1" start="1">
          <li>필수 수집 정보: 휴대폰 번호, 이메일 주소, 이름, 생년월일 및 성별</li>
        </ol>
        <br />
        <h3>제7조(회사 서비스 제공을 위한 정보)</h3>
        <p>회사는 이용자에게 회사의 서비스를 제공하기 위하여 다음과 같은 정보를 수집합니다.</p>
        <ol type="1" start="1">
          <li>필수 수집 정보: 아이디, 이메일 주소, 이름, 생년월일 및 연락처</li>
        </ol>
        <ol type="1" start="2">
          <li>선택 수집 정보: 학생과의 관계, 학생 성별, 학교명, 현재 학년, 계열 구분</li>
        </ol>
        <br />
        <h3>제8조(서비스 이용 및 부정 이용 확인을 위한 정보)</h3>
        <p>
          회사는 이용자의 서비스 이용에 따른 동계•분석 및 부정이용의 확인•분석을 위하여 다음과 같은 정보 를 수집합니다.
        ...
        <ol type="1" start="2">
          <li>
            전항에도 불구하고 회사는 내부 방침에 의해 서비스 부정이용기록은 부정 가입 및 이용 방지를 위하여 회 원 탈퇴
            시점으로부터 최대 1년간 보관합니다.
          </li>
        </ol>
        <br />
        <h3>제12조(법령에 따른 개인정보의 보유 및 이용기간)</h3>
        ...
        <br />
        <h3>제13조(개인정보의 파기원칙)</h3>
        <p>
          회사는 원칙적으로 이용자의 개인정보 처리 목적의 달성, 보유•이용기간의 경과 등 개인정보가 필요하 지 않을
        ...
        <ol type="1" start="1">
          <li>
            이용자가 회원가입 등을 위해 입력한 정보는 개인정보 처리 목적이 달성된 후 별도의 DB로 옮겨져(종이 의 경우
            별도의 서류함) 내부 방침 및 기타 관련 법령에 의한 정보보호 사유에 따라(보유 및 이용기간 참
          </li>
        </ol>
        <ol type="1" start="2">
          <li>조) 일정 기간 저장된 후 파기 되어집니다.</li>
        </ol>
        <ol type="1" start="3">
        ...
        <h3>제15조(개인정보과기방법)</h3>
        <p>
          회사는 전자적 파일형태로 저장된 개인정보는 기록을 재생할 수 없는 기술적 방법을 사용하여 삭제하 며, 종이로
        ...
        <ol type="1" start="1">
          <li>
            회사는 전자적 전송매체를 이용하여 영리목적의 광고성 정보를 전송하는 경우 이용자의 명시적인 사전동 의를
            받습니다. 다만, 다음 각호 어느 하나에 해당하는 경우에는 사전 동의를 받지 않습니다
            <p>
              가. 회사가 재화 등의 거래관계를 통하여 수신자로부터 직접 연락처를 수집한 경우, 거래가 종료된 날로 부터
              6개월 이내에 회사가 처리하고 수신자와 거래한 것과 동종의 재화 등에 대한 영리목적의 광고 성 정보를
              전송하려는 정우
              <br />
              나. 「방문판매 등에 관한 법률」 에 따른 전화권유판매자가 육성으로 수신자에게 개인정보의 수집출처를
              고지하고 전화권유를 하는 경우
              <br />
            </p>
          </li>
        ...
        <ol type="1" start="4">
          <li>
            회사는 전자적 전송매체를 이용하여 영리목적의 광고성 정보를 전송하는 검우 다음의 사항 등을 광고성 정보에
            구체적으로 밝힙니다.
            <br />
            가. 회사명 및 연락처
            <br />
        ...
        <ol type="1" start="5">
          <li>
            ...
            조치를 하지 않습니다.
            <br />
            가. 광고성 정보 수신자의 수신거부 또는 수신동의의 철회를 회피• 방해하는 조치 <br />
            <p>
        ...
        <ol type="1" start="1">
          <li>
            이용자 및 법정 대리인은 언제든지 등록되어 있는 자신의 개인정보를 조회하거나 수정할 수 있으며 개인 정보수집
            동의 철회를 요청할 수 있습니다.
            <br />
          </li>
        </ol>
        <ol type="1" start="2">
          <li>
            이용자 및 법정 대리인은 자신의 가입정보 수집 등에 대한 동의를 철회하기 위해서는 개인정보보호책임 자 또는
        ...
        <ol type="1" start="2">
          <li>
            회사는 전항의 경우에 개인정보의 정정을 완료하기 전까지 개인정보를 이용 또는 제공하지 않으며 잘못 된
        ...
        <ol type="1" start="3">
          <li>
            이용자는 전자우편주소, 비밀번호 등에 대한 보안을 유지할 책임이 있으며 제3자에게 이를 양도하거나 대 여할 수
            없습니다.
          </li>
        </ol>
        <br />
        <h3>제20조(개인정보 유출 등에 대한 조치)</h3>
        <p>
        ...
        <br />
        <h3>제21조(개인정보 유출 등에 대한 조치의 예외)</h3>
        <p>
          회사는 전조에도 불구하고 이용자의 연락처를 알 수 없는 등 정당한 사유가 있는 경우에는 회사의 홈폐이지에 30일
          이상 게시하는 방법으로 전조의 통지를 갈음하는 조치를 취할 수 있습니다.
        </p>
        <br />
        <h3>제22조(개인정보 자동 수집 장치의 설치•운영 및 거부에 관한 사항)</h3>
        <ol type="1" start="1">
          <li>
            회사는 이용자에게 개별적인 맞춤서비스를 제공하기 위해 이용 정보를 저장하고 수시로 불러오는 개인정 보자동
            수집장치(이하 &#x27;쿠키)를 사용합니다. 쿠키는 웹사이트를 운영하는데 이용되는 서버(http)가 이용 자의
            웨브라우저(PC 및 모바일을 포함)에게 보내는 소량의 정보이며 이용자의 저장공간에 저장되기도 함 니다.
          </li>
        </ol>
        <ol type="1" start="2">
          <li>
            이용자는 쿠키 설치에 대한 선택권을 가지고 있습니다. 따라서 이용자는 웹브라우저에서 옵션을 설정함 으로써 모든
            쿠키를 허용하거나, 쿠키가 저장될 때마다 확인을 거치거나, 아니면 모든 쿠키의 저장을 거부 할 수도 있습니다.
          </li>
        </ol>
        <ol type="1" start="3">
          <li>
        ...
        <br />
        <h3>제23조(쿠키 설치 허용 지정 방법)</h3>
        <p>웹브라우저 옵션 선정을 통해 쿠키 허용, 쿠키 차단 등의 설정을 할 수 있습니다.</p>
        <ol type="1" start="1">
          <li>
            Edge : 웨브라우저 우측 상단의 설정 메뉴 &gt; 쿠키 및 사이트 권한 &gt; 쿠키 및 사이트 데이터 관리 및 삭제
          </li>
        </ol>
        <ol type="1" start="2">
        ...
        <ol type="1" start="3">
          <li>전화번호: 010-3924-3395</li>
        </ol>
        <ol type="1" start="4">
          <li>이메일: privacy@sseduacademy.com</li>
        </ol>
        <br />
        <h3>제25조(권익침해에 대한 구제방법)</h3>
        <p>
          1. 정보주체는 개인정보침해로 인한 구제를 받기 위하여 개인정보분쟁조정위원회, 한국인터넷진흥원 개인
          정보침해신고센터 등에 분쟁해결이나 상담 등을 신청할 수 있습니다. 이 밖에 기타 개인정보침해의 신고, 상담에
        ...
        <ol type="1" start="1">
          <li>
            회사는 정보주체의 개인정보자기결정권을 보장하고, 개인정보침해로 인한 상담 및 피해 구제를 위해 노 력하고
        ...
        <ol type="1" start="2">
          <li>
            ...
            규정에 의한 요구에 대 하여 공공기관의 장이 행한 처분 또는 부작위로 인하여 권리 또는 이익의 침 해를 받은 자는
